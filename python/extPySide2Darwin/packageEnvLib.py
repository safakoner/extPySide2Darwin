...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extPySide2Darwin/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extPySide2Darwin.packageEnvLib    @brief [ MODULE ] - Package environment module.
