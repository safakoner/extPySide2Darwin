...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @package extPySide2Darwin                            @brief [ PACKAGE   ] - PySide2 (Python 3) for Mac OS.
## @dir     extPySide2Darwin/python                     @brief [ DIRECTORY ] - Python path.
## @dir     extPySide2Darwin/python/extPySide2Darwin    @brief [ DIRECTORY ] - Python package.
## @file    extPySide2Darwin/packageInfoLib.py          @brief [ FILE      ] - Package info module.
## @package extPySide2Darwin.packageInfoLib             @brief [ MODULE    ] - Package info module.
...
NAME                = 'extPySide2Darwin'

## [ str ] - Version of the package.
VERSION             = '5.15.2'

## [ str ] - Description about the package.
DESCRIPTION         = 'PySide2 (Python 3) for Mac OS.'
...
PYTHON_PACKAGES     = ['extPySide2Darwin']